        ...
        pages: [
          {
            ...
            text: [
              ...
              '결제수단: 법인카드',
              '승인번호: 26081201',
              '품목: 쌀 및 곡류 | 수량: 1 | 금액: 180,000원',
              '품목: 채소 및 과일 | 수량: 1 | 금액: 148,000원',
              '품목: 단백질 식재료 | 수량: 1 | 금액: 100,000원',
              '공급가액: 389,091원',
              '부가세: 38,909원',
              '합계: 428,000원',
            ].join(' '),
        ...
        pages: [
          {
            ...
            text: [
              ...
              '결제수단: 법인카드',
              '승인번호: 26081201',
              '품목: 쌀 및 곡류 수량: 금액: 180,000원 | 1 |',
              '품목: 채소 및 과일 수량: 금액: 148,000원 | 1 |',
              '품목: 단백질 식재료 수량: 금액: 100,000원 | 1 |',
              '공급가액: 389,091원',
              '부가세: 38,909원',
              '합계: 428,000원',
            ].join(' '),
